                ...
                <div class="col-12">
                    <form action="{{ route("admin.post.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group w-50">
                            ...
                            <select class="select2" name="tag_ids[]" multiple="multiple" data-placeholder="Add tags" style="width: 100%;">
                                @foreach($tags as $tag)
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-block btn-primary col-1" value="Add">
                        </div>
                    </form>
                </div>
            </div>
